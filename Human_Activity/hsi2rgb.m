...
%   RGB = HSI2RGB(HSI) converts an HSI image to RGB, where HSI is assumed
%   to be of class double with:
%       hsi(:,:,1) = hue image, assumed to be in the range [0, 1] by having
...
%Implement the converstion equation 
